...
<div class="modern-hero">
    <div class="hero-content">
        <div class="hero-badge">🐟 Svaigums garantēts</div>
        <h1 class="hero-title">Ģimenes Zivju Veikals</h1>
        <p class="hero-subtitle">Svaigas un garšīgas zivis tieši no jūras līdz jūsu galdam</p>
