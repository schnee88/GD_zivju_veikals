...
<div class="production-plan-page">
    ...
    <div class="batches-list">
        ...
        <div class="batch-card" style="border: 3px solid #3498db; border-radius: 12px; padding: 20px; margin-bottom: 30px; background: white; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px; padding-bottom: 15px; border-bottom: 2px solid #f0f0f0;">
                ...
                <span style="background: #3498db; color: white; padding: 8px 16px; border-radius: 20px; font-size: 0.95em; font-weight: bold;">
                    🗓️ PLĀNOTS
                </span>
            </div>

            <!-- Production date and description -->
            <div style="margin-bottom: 20px;">
                <p style="margin: 8px 0; color: #555; font-size: 1em;">
                    <strong style="color: #2c3e50;">📅 Plānots gatavs:</strong>
            ...
            <div style="background: #f8f9fa; padding: 15px; border-radius: 8px; margin-bottom: 20px;">
                ...
                <div style="overflow-x: auto;">
                    <table style="width: 100%; border-collapse: collapse; background: white; border-radius: 6px; overflow: hidden; min-width: 600px;">
                        <thead>
                        ...
                        <tbody>
                            ...
                            <tr style="border-bottom: 1px solid #e9ecef;">
                                ...
                                <td style="padding: 12px; text-align: center; font-weight: bold; color: #3498db; font-size: 1.1em;">
                                    {{ $fish->pivot->quantity }}
                                </td>
