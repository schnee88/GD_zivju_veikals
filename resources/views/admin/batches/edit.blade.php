...
<div class="container">
    ...
    <form action="{{ route('admin.batches.update', $batch) }}" method="POST">
        ...
        <div id="fishes-container">
            ...
            <div class="fish-row" style="border: 1px solid #ddd; padding: 20px; margin-bottom: 20px; border-radius: 8px; background: #f9f9f9;">
                <div style="display: grid; grid-template-columns: 2fr 1fr 1fr auto; gap: 20px; align-items: start;">
                    <div class="form-group">
                        <label>Zivs:</label>
                        <select name="fishes[{{ $index }}][fish_id]" required style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 4px; height: 40px;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="fishes[{{ $index }}][quantity]" value="{{ old('fishes.' . $index . '.quantity', $fish->pivot->quantity) }}" step="0.01" min="0" required style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 4px;">
                    </div>

                    <div class="form-group">
                        <label>Mērvienība:</label>
                        <select name="fishes[{{ $index }}][unit]" required style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 4px; height: 40px;">
...
<script>
    ...
    <div style="border: 1px solid #ddd; padding: 20px; margin-bottom: 20px; border-radius: 8px; background: #f9f9f9;">
        <div style="display: grid; grid-template-columns: 2fr 1fr 1fr auto; gap: 20px; align-items: start;">
            <div class="form-group">
                <label>Zivs:</label>
                <select name="fishes[${fishIndex}][fish_id]" required style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 4px; height: 40px;">
                    <option value="">Izvēlieties zivi</option>
                    @foreach($fishes as $fishOption)
            ...
            <div class="form-group">
                <label>Daudzums:</label>
                <input type="number" name="fishes[${fishIndex}][quantity]" step="0.01" min="0" required style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 4px;">
            </div>

            <div class="form-group">
                <label>Mērvienība:</label>
                <select name="fishes[${fishIndex}][unit]" required style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 4px; height: 40px;">
