        ...
        <div class="checkout-grid">
                ...
                <div class="checkout-section">
                    ...
                    <div class="cart-item">
                        ...
                        <div class="item-details">
                            ...
                            <p><strong>Daudzums:</strong> {{ $item->quantity }} {{ $item->batch->fishes()->where('fish_id', $item->fish_id)->first()->pivot->unit }}</p>
            ...
            <div>
                <div class="checkout-section">
                    ...
                    <form action="{{ route('cart.storeFromCart') }}" method="POST" id="checkoutForm">
                        @csrf
